const SpacesContent = {
    ...
    pics5: require('../images/reels/spaces/5.jpg').default,
    pics6: require('../images/reels/spaces/11.jpg').default,
    pics7: require('../images/reels/spaces/7.jpg').default,
    ...
    pics12: require('../images/reels/spaces/l3.png').default,
}
