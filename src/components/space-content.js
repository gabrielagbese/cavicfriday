...
const SpaceContent = {
    ...
    training: {
        ...
        writeup: "Our events/workshop space covers 56 m² and has capacity to sit up to 40 persons and is ideal for hands-on training, closed door presentations and small social events such as book club activities, public discourse, lectures, etc.Skill acquisition and refinement are continuous processes. The Training Space is a tangible manifestation of CAVIC's commitment to lifelong learning. Whether it's a workshop on digital tools, a masterclass on African art forms, or a course on entrepreneurship, this space ensures that hum members are continuously equipped with skills that enhance their journey.",
