...
const SpaceContent = {
    ...
    conference: {
        ...
        writeup: "Rent this well-lit room for training or to hold professional meetings and presentations. The space can also be used for hosting business events, workshops and seminars with a maximum capacity of 15 people.In today's interconnected world, collaboration is not restricted by geography. The Conference Rooms, with their projectors and conferencing equipment, become hubs for global collaboration. Hub members can hold meetings and brainstorming sessions or connect with global audiences, mentors, or stakeholders. In essence, these rooms ensure that the residency, while rooted in Africa, has a global footprint.",
    ...
    training: {
        ...
        writeup: "Our events/workshop space covers 150 m² and has capacity to sit up to 70-80 persons and is ideal for hands-on training, closed door presentations and social events such as book club activities, public discourse, lectures, film screenings etc.Skill acquisition and refinement are continuous processes. The Training Space is a tangible manifestation of CAVIC's commitment to lifelong learning. Whether it's a workshop on digital tools, a masterclass on African art forms, or a course on entrepreneurship, this space ensures that hum members are continuously equipped with skills that enhance their journey.",
        image: require('../images/reels/spaces/11.jpg').default,
        image2: null,
        image3: null,
        image4: null,
    },
